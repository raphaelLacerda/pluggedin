...
<body>
									...
									FB
											.api(
													...
													function(me) {
														if (me.name) {
															document
																	.getElementById('auth-displayname').innerHTML = me.name;
														}
													})
	...
	<div id="auth-status">
		<div id="auth-loggedout">
			<a href="#" id="auth-loginlink">Login with FB...!</a>
		</div>
		<div id="auth-loggedin" style="display: none">
			Hi, <span id="auth-displayname"></span> (<a href="#" id="auth-logoutlink">logout</a>)
		</div>
		
		<div class="fb-login-button" data-show-faces="true" data-width="500" data-max-rows="2"></div>
	</div>
