...
public class FacebookUserFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		if (api_key == null || secret == null) {
			throw new ServletException("Cannot initialise Facebook User Filter because the " + "facebook_api_key or facebook_secret context init "
...
//                        MDC.put(ipAddress, req.getRemoteAddr());
			...
			System.out.println(userClient.getApiKey());
			try {
				System.out.println(userClient.users_getLoggedInUser());
			...
			System.out.println(facebook.get_loggedin_user());
			System.out.println(facebook.getSecret());
			System.out.println(facebook.isLogin());
			System.out.println(facebook.getFacebookRestClient());
			...
			try {
				...
				logger.info("User Facebook" + facebookUserID);
